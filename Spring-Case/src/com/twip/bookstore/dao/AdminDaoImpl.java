...
public class AdminDaoImpl implements AdminDao {
    ...
    public Boolean deleteBook(Book book) {
        ...
        if(!re){
            ...
            String sql = "delete from book_store_ware where book_name=?";
    ...
    public Boolean insertBookBatch(Book book) {
        ...
        if(!re){
            ...
            String sql = "update book_store_ware set book_amount=book_amount+? where book_name=?";
            Object[] args = {book.getBookAmount(), book.getBookName()};
